                        ...
                        <div class="card">
                            <div class="card-header ">
                                <div class="d-flex justify-content-between">
                                    <h3>Danh mục</h3>
                                    <button type="button" class="btn btn-orange" onclick="newCat()">
                                        <i
                                ...
                                <div class="modal fade" id="modalCat" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="catLabel">Thêm danh mục</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="idCat" class="labels">ID Danh mục</label>
                                                    <fieldset disabled>
                                                ...
                                                <div class="mb-3">
                                                    <label for="nameCat" class="labels">Tên danh mục</label>
                                                    <input id="nameCat" type="text" class="form-control"
                                                           placeholder="Danh Mục" value="">
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label" for="descCat">Mô tả Danh Mục</label>
    ...
    $(document).ready(function () {
        table = $('#tableCat').DataTable({
            ...
            language: {
                ...
                info: "Bài viết từ _START_ đến _END_ trong _TOTAL_ Danh mục",
                infoEmpty: "",
                loadingRecords: "",
                infoFiltered: "",
